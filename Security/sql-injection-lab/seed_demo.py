...
async def seed_database():
    ...
    async with engine.connect() as conn:
        ...
        users = [
            {"name": "alice", "password_hash": "e6d21a69daa4a8ebca755c1d5808b85b"},
            {"name": "bob", "password_hash": "530c81a25a362791fff683c511c2edd8"},
            {"name": "eva", "password_hash": "f8c87688d560489d977c7414ca146d37"},
        ]
